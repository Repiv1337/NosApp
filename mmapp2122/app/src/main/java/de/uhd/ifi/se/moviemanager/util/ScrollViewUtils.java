...
import de.uhd.ifi.se.moviemanager.ui.detail.DeepScrollTouchListener;
...
public final class ScrollViewUtils {
    ...
    public static void scrollToViewIfNeeded(final ScrollView scrollView,
                                            final View view) {
    ...
    private static boolean isViewVisible(final ScrollView scrollView,
                                         final View view) {
    ...
    public static boolean isScrollViewAbove(final ScrollView scrollView,
                                            final View view) {
        final Rect scrollBounds = new Rect();
        scrollView.getDrawingRect(scrollBounds);
    ...
    public static boolean isScrollViewBelow(final ScrollView scrollView,
                                            final View view) {
        final Rect scrollBounds = new Rect();
        scrollView.getDrawingRect(scrollBounds);
